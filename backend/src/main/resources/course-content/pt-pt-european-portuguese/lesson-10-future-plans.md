...
### Future Time
- **Amanh√£** - Tomorrow
- **Depois de amanh√£** - Day after tomorrow
- **Pr√≥xima semana** - Next week
- **Pr√≥ximo m√™s** - Next month
- **Pr√≥ximo ano** - Next year
- **Em breve** - Soon
...
Topics to cover:
- "O que vais fazer amanh√£?" (What are you going to do tomorrow? - tu)
...
- Summer holidays (f√©rias) sacred
- Algarve popular summer destination
- Portuguese diaspora returns for summer

## Course Summary

Parab√©ns! You've completed the A1-A2 European Portuguese foundation course. You can now:
...
- Add endings to infinitive: -ei, -·s, -·, -emos, -eis, -„o

Examples:
- Falar: eu falarei, tu falar·s, ele falar·
- Comer: eu comerei, tu comer·s, ele comer·
- Partir: eu partirei, tu partir·s, ele partir·
...
- **Amanh„** - Tomorrow
- **Na prÛxima semana** - Next week
- **No prÛximo mÍs** - Next month
- **No prÛximo ano** - Next year
...
- **Espero aprender portuguÍs** - I hope to learn Portuguese
...
- Express future plans: "Amanh„ vou estudar portuguÍs"
