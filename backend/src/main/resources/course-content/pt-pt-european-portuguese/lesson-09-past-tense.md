...
### PretÃ©rito Perfeito with Tu

**Rule:** Tu form adds -ste

-AR: -ei, -aste, -ou, -Ã¡mos, -aram
...
## Extended Grammar: Pretérito Perfeito (Simple Past)

### Regular Verb Endings
- **-AR verbs**: -ei, -aste, -ou, -ámos/-ámos, -aram
- **-ER verbs**: -i, -este, -eu, -emos, -eram
- **-IR verbs**: -i, -iste, -iu, -imos, -iram

Examples:
- Falar (to speak): eu falei, tu falaste, ele falou
- Comer (to eat): eu comi, tu comeste, ele comeu
- Partir (to leave): eu parti, tu partiste, ele partiu

## Additional Grammar: Irregular Verbs in Past Tense

### Common Irregular Verbs
- **Ser/Ir** (same conjugation): fui, foste, foi, fomos, foram
...
- Portuguese history and cultural past important
- Family stories and traditions highly valued
- Past tense needed for storytelling

## Practice Patterns

- Talk about yesterday: "Ontem estudei português"
- Describe past trips: "Viajei para Lisboa"
- Express past habits: "Eu costumava..." (I used to)


### More Past Time Expressions
- **Há dois dias** - Two days ago
- **Há três semanas** - Three weeks ago
- **Há um mês** - One month ago
...
### Past Experiences
- **Já visitei Portugal** - I have already visited Portugal
- **Nunca comi bacalhau** - I have never eaten codfish
- **Viajei para o Algarve** - I traveled to the Algarve

### Forming Questions in Past Tense
- **O que fizeste ontem?** - What did you do yesterday? (tu)
- **O que fez ontem?** - What did you do yesterday? (você)
- **Quando vieste a Portugal?** - When did you come to Portugal?

## Additional Practice Patterns

- Describe weekend activities: "No sábado fui ao cinema"
- Talk about past experiences: "Já estive em Lisboa"
- Express previous knowledge: "Já sabia isso" (I already knew that)
