...
**Exception:** Verbs ending in -ieren don't get "ge-":
...
### Common Regular Verbs (Past Participle)
- **Spielen → gespielt** - Played
- **Arbeiten → gearbeitet** - Worked
- **Lernen → gelernt** - Learned
- **Kaufen → gekauft** - Bought
...
Practice talking about what you did yesterday using Perfekt.

Topics to cover:
- "Gestern habe ich den ganzen Tag gearbeitet" (Yesterday I worked all day)
- "Ich habe im Restaurant gegessen" (I ate at a restaurant)
- "Am Abend habe ich ferngesehen" (In the evening I watched TV)
- "Ich habe nicht viel geschlafen" (I didn't sleep much)
...
Topics to cover:
- "Am Samstag habe ich Sport gemacht" (Saturday I did sports)
...
- "Hast du schon Berlin besucht?" (Have you visited Berlin yet?)
- "Ich bin vor zwei Jahren nach Deutschland gereist" (I traveled to Germany two years ago)
- "Ich habe es noch nicht gemacht" (I haven't done it yet)

## Practice Patterns

- Conjugate haben with all pronouns + past participle
- Practice regular past participles: ge-[stem]-t
- Form irregular past participles: gegessen, getrunken, gesehen
...
- Perfekt is the standard past tense in spoken German
- In writing, Präteritum is more common for some verbs
- Germans rarely use simple past (Präteritum) in conversation
- "Haben" vs. "sein" distinction is crucial (next week: movement verbs with sein!)
- Perfekt expresses both simple past and present perfect
- Word order with Perfekt is VERY important - participle at end!
